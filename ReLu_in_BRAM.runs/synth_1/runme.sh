...
HD_PWD='C:/Users/User/ACTIVATION FUNCTION/ReLu_in_BRAM/ReLu_in_BRAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ReLu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ReLu.tcl
