...
HD_PWD='C:/Users/User/ACTIVATION FUNCTION/ReLu_in_BRAM/ReLu_in_BRAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ReLu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ReLu.tcl -notrace
